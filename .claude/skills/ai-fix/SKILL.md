...
description: >-
  ...
  invokes /ai-fix — the agent will not reach for this skill on its own.
disable-model-invocation: true
---

# /ai-fix — Bug Diagnosis and Fix Proposal

You invoke this by typing `/ai-fix` — the agent won't reach for it on its own.
