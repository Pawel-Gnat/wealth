...
description: >-
  ...
  invokes /ai-build <feature-plan> — the agent will not reach for this skill on its own.
disable-model-invocation: true
---

# /ai-build — Feature Build

You invoke this by typing `/ai-build <feature-plan>` — the agent won't reach for it on its own.
