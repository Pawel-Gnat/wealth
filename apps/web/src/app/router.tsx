...
import { IncomeAddPage, IncomeEditPage, IncomesListPage } from '@/pages/incomes'
		...
		<Routes>
			...
			<Route element={<AuthenticatedLayout />}>
				<Route element={<DashboardLayout />}>
					...
					/>
					<Route
						path={APP_ROUTES.incomes.list}
						element={<IncomesListPage />}
					/>
					<Route
						path={APP_ROUTES.incomes.add}
						element={<IncomeAddPage />}
					/>
					<Route
