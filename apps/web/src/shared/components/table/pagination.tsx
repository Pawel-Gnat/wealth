...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/shared/lib/ui/select'
	...
	return (
		<div className='flex items-center justify-between flex-wrap gap-2'>
			...
			<div className='flex items-center gap-2 flex-wrap'>
				<Text size='xs'>
					{t('pagination.page', { ns: 'common' })} {table.getState().pagination.pageIndex + 1}{' '}
