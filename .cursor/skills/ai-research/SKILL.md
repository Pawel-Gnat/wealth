...
description: >-
  ...
  /ai-research <feature-plan> — the agent will not reach for this skill on its own.
disable-model-invocation: true
---

# /ai-research — Feature Research

You invoke this by typing `/ai-research <feature-plan>` — the agent won't reach for it on its own.
