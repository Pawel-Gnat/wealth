...
description: >-
  ...
  /ai-plan — the agent will not reach for this skill on its own.
disable-model-invocation: true
---

# /ai-plan — Feature Planning

You invoke this by typing `/ai-plan` — the agent won't reach for it on its own.
